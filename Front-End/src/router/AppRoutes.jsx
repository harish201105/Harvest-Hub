...
import WeatherReport from "../components/farmer/WeatherReport.jsx"; // Import WeatherReport component
    ...
    return (
        <Routes>
            ...
            <Route path={"/"} element={<FarmerLayout/>}>
                ...
                <Route path='/weatherreport' element={<WeatherReport />} /> {/* Added WeatherReport route */}
            </Route>
